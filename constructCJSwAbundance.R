...
#     }
  ...
  for(q in 1:nSampleRowsEval){
      alive[sampleRowsEval[q,1],sampleRowsEval[q,2],sampleRowsEval[q,3]]<-
        sum(z[sampleRowArray[1:nSampleRows[sampleRowsEval[q,1],sampleRowsEval[q,2],sampleRowsEval[q,3]],
              sampleRowsEval[q,1],sampleRowsEval[q,2],sampleRowsEval[q,3]]])
  }
